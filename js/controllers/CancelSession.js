function CancelSessionCntrl()
{
	...
	function init()
	{
		$('#cancel_btn').click(function(){showCancelConfirm();});
		$('#cancel_back_btn').click(function(){hideCancelConfirm();});
		$('#cancel_conf_btn').click(function()
			{
				...
				$.ajax({
				   ...
				   error: function()
						{
							alert('Cancel operation failed. Please check your connection and try again');
